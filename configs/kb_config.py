...
# 默认使用的知识库
DEFAULT_KNOWLEDGE_BASE = "XJ_knowledge"
...
text_splitter_dict = {
    ...
    "My_Chinese_splitter": {
        "source": "huggingface",  # 选择tiktoken则使用openai的方法
        "tokenizer_name_or_path": "", #如果选择huggingface则使用huggingface的方法，部分tokenizer需要从Huggingface下载
    },
    "My_English_splitter": {
        "source": "huggingface",  # 选择tiktoken则使用openai的方法
        "tokenizer_name_or_path": "", #如果选择huggingface则使用huggingface的方法，部分tokenizer需要从Huggingface下载
...
TEXT_SPLITTER_NAME = "My_Chinese_splitter"
